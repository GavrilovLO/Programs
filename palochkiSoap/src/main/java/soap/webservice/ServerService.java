 ...
 * 
 */
@WebServiceClient(name = "ServerService", targetNamespace = "http://soap/", wsdlLocation = "http://localhost:2280/Palochki?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:2280/Palochki?wsdl");
